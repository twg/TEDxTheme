...
class TalkPostType {
    ...
    function render_video_meta_boxes () {
        ...
        $renderer->data['talk_video_id'] = get_post_meta(get_the_ID(), '_talk_video_id', true);
        echo $renderer->render('admin/custom_post_types/talk/talk_video_id');
    }

    function render_speaker_id_meta_boxes () {
        $renderer = new Renderer();
        $renderer->data['talk_speaker_id'] = get_post_meta(get_the_ID(), '_talk_speaker_id', true);
        $renderer->data['speakers']        = $this->get_speakers();
        echo $renderer->render('admin/custom_post_types/talk/speaker_id');
    }

    function render_speaker_name_meta_boxes () {
        $renderer = new Renderer();
        $renderer->data['talk_speaker_name'] = get_post_meta(get_the_ID(), '_talk_speaker_name', true);
        echo $renderer->render('admin/custom_post_types/talk/speaker_name');
    }

    function render_speaker_role_meta_boxes () {
        $renderer = new Renderer();
        $renderer->data['talk_speaker_role'] = get_post_meta(get_the_ID(), '_talk_speaker_role', true);
        echo $renderer->render('admin/custom_post_types/talk/speaker_role');
    }
